...
################################################################################################
        self.test_acc.append(test_acc.cpu().detach().numpy())
        self.train_acc.append(train_meters["top1"].avg.cpu().detach().numpy())
        self.rk_loss.append(train_meters["rk_loss"].avg)
        self.kl_loss.append(train_meters["kl_loss"].avg)

        df = [self.test_acc,self.train_acc,self.rk_loss,self.kl_loss]
...
######################################################
        rk_loss = losses_dict['loss_rk'].mean()
        kl_loss = losses_dict['loss_kd'].mean()
        #print(rk_loss,kl_loss)
######################################################
...
######################################################################################################
        train_meters["rk_loss"].update(rk_loss.cpu().detach().numpy().mean(), batch_size)
        train_meters["kl_loss"].update(kl_loss.cpu().detach().numpy().mean(), batch_size)
######################################################################################################        
